...
namespace WindowsApplication3 {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CarsRow AddCarsRow(string Trademark, string Model, string Category, byte[] Picture, decimal Price) {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Tr" +
                ...
                "D `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (" +
                "`Price` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `Category`, `Picture`, `Price`) VALUES " +
                "(?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `Category` = ?, `Picture` = ?, `Price` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsApplication3.Properties.Settings.Default.CarsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Trademark, Model, Category, Picture, Price FROM Cars";
        ...
        public virtual int Delete(int Original_ID, string Original_Trademark, string Original_Model, string Original_Category, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string Trademark, string Model, string Category, byte[] Picture, global::System.Nullable<decimal> Price) {
            if ((Trademark == null)) {
        ...
        public virtual int Update(string Trademark, string Model, string Category, byte[] Picture, global::System.Nullable<decimal> Price, int Original_ID, string Original_Trademark, string Original_Model, string Original_Category, global::System.Nullable<decimal> Original_Price) {
            if ((Trademark == null)) {
