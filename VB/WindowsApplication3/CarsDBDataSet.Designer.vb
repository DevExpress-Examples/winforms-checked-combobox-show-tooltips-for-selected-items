...
Namespace WindowsApplication3
	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarsRow(ByVal Trademark As String, ByVal Model As String, ByVal Category As String, ByVal Picture() As Byte, ByVal Price As Decimal) As CarsRow
				Dim rowCarsRow As CarsRow = (CType(Me.NewRow(), CarsRow))
				Dim columnValuesArray() As Object = { Nothing, Trademark, Model, Category, Picture, Price}
	...
	End Class
End Namespace
Namespace WindowsApplication3.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Tr" & "ademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AN" & "D `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (" & "`Price` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `Category`, `Picture`, `Price`) VALUES " & "(?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `Category` = ?, `Picture` = ?, `Price` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, Category, Picture, Price FROM Cars"
		...
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Category As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CStr(Original_Category))
			End If
			If (Original_Price.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(7).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CDec(Original_Price.Value))
			Else
		...
		Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal Category As String, ByVal Picture() As Byte, ByVal Price As Global.System.Nullable(Of Decimal)) As Integer
			...
			Else
				Me.Adapter.InsertCommand.Parameters(2).Value = (CStr(Category))
			End If
			...
			If (Price.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(4).Value = (CDec(Price.Value))
			Else
		...
		Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal Category As String, ByVal Picture() As Byte, ByVal Price As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_Category As String, ByVal Original_Price As Global.System.Nullable(Of Decimal)) As Integer
			If (Trademark Is Nothing) Then
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CStr(Category))
			End If
			If (Picture Is Nothing) Then
			...
			End If
			If (Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CDec(Price.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CStr(Original_Category))
			End If
			If (Original_Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CDec(Original_Price.Value))
			Else
